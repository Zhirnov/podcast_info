...
def get_podcast_summary(podcast_transcript):
  ...
  instructPrompt = """
  Given the following podcast transcript,
  please provide a concise summary presented by the host and guests.
  """
...
def get_podcast_guest(podcast_transcript):
  ...
  completion = openai.ChatCompletion.create(
    ...
    functions=[
    {
        ...
        "description": "extract information about podcast guest",
        "parameters": {
            "type": "object",
            "properties": {
                "guest_name": {
                    "type": "string",
                    "description": "exctract podcast guest name",
                },
                "unit": {"type": "string"},
            },
            "required": ["guest_name"],
...
def get_podcast_highlights(podcast_transcript):
  ...
  instructPrompt = """
  Given the following podcast transcript,
  please provide highlights of the main ideas,
  key insights,
  any actionable recommendations discussed by the host and guests,
  and any significant arguments presented by the host and guests.
  """
